...
# Source file: examples/k_module_problem/initial_program.py (verbatim below this header).
# Only adaptation: this header. Feedback reveals only how many modules are correct, never which.
# EVOLVE-BLOCK-START
"""
...
def configure_pipeline():
    ...
    config = {
        'loader': 'csv_reader',       # Try different loaders
        'preprocess': 'normalize',    # Try different preprocessing
        'algorithm': 'quicksort',     # Try different algorithms
        'formatter': 'json',          # Try different formatters
    }
